...
INSERT INTO Customers (CPR_number, policy_number, password, name, address, phone_number, email, balance) VALUES
...
INSERT INTO Customers (CPR_number, policy_number, password, name, address, phone_number, email, balance) VALUES
(1003, 'P123458', 'password789', 'Alice Johnson', '789 Pine St', '+1 555 3456789', 'alice.johnson.com', 3000.00);
...
('P123459', 'Home Insurance', '2023-03-01', '2024-03-01', 1500.00, 1004);

-- wrong CPR number to check the foreign key constraint
INSERT INTO Policies (policy_number, policy_type, start_date, end_date, premium_amount, CPR_number) VALUES
